...
@pytest.mark.parametrize("input_text,expected", [
    ...
    ("Actually, I am happy to help", ", I am help"), # "happy to" -> removed. "Actually" -> removed.
    ...
    ("Newlines\nare\tcompressed", "Newlines are compressed"),
    ...
    ("Actually, the authentication function    needs to be configured !", ", auth fn needs to be config!"),
])
...
def test_compress_payload_dict():
    payload = {
        ...
        "nested": {
            "description": "This is actually really important !"
        }
    }
    expected = {
        "id": 1,
...
def test_compress_payload_pydantic_model():
    ...
    assert compressed.info == "it configures DB conn." # "configures" -> is not a synonym rule!
